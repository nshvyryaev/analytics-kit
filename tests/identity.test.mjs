...
test('разделители в платформе и идентификаторе не создают коллизии', () => {
  // playerSubject('vk', '1:2', KEY) и playerSubject('vk:1', '2', KEY)
  // не должны давать один и тот же псевдоним. Без префикса длиной обе
  // функции создали бы p:vk:1:2 и коллидировали.
  assert.notEqual(playerSubject('vk', '1:2', KEY), playerSubject('vk:1', '2', KEY));
});
